...
describe('terminal utilities', () => {
  ...
  test('validates hexadecimal colors', () => {
    ...
    try {
      ...
      expect(colorize('red', 'Komut')).toContain('\x1b[31m');
      expect(colorize('#57b497', 'Komut')).toContain('38;2;87;180;151');
      expect(() => colorize('#fff', 'Komut')).toThrow('Expected #RRGGBB');
      expect(() => colorize(['#000000', '#ffffff'], 'Komut')).toThrow(
